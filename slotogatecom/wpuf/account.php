<div class="wpuf-dashboard-container">
    <nav class="wpuf-dashboard-navigation">
        <ul>
			<li><a href="/account/"><?php echo __('Account', 'websitelangid');?></a></li>
			<li><a href="/favorites/"><?php echo __('Favorites', 'websitelangid');?></a></li>
			<li><a href="/account/?section=edit-profile"><?php echo __('Edit Profile', 'websitelangid');?></a></li>
            <?php
			/*
