				...
				<section>
					<div class="taxonomy-archive-intro taxonomy-archive-intro-align-top">
						<div class="taxonomy-archive-content">
							...
							<?php }else{?>
								<?php echo vsprintf(__('<h1>%s</h1><p>%s is a gaming software provider. It has produced many products for online gambling including slots, video poker, and table games, with new releases happening regularly. %s employs the dual release approach, which makes its software compatible with both desktop and mobile devices.</p><p>If you want to know more about %s, you are at the right place. We reveal more information in our guide.</p>', 'websitelangid'), array($term_name, $term_name, $term_name, $term_name));?>
							<?php }?>
						</div>
