			...
			<div class="align">
				<section>
					<header>
						...
						<?php echo do_shortcode('[gdrts_stars_rating type="terms.casinos_types" id="'.$term_id_original.'"]');?>
					</header>
					<?php
					if(is_paged()){
						if($_POST){
...
jQuery(function(){
	jQuery(".clear-btn").click(function(){
		...
		jQuery('.casinos-filter').submit();
					...
					$args = array('post_type'=>'casinos', 'meta_key'=>$casinos_meta_key, 'orderby'=>$casinos_orderby, 'order'=>$casinos_order, 'paged'=>$paged, 'tax_query'=>array($current_term, $country, $deposit, $withdrawal, $currency));
					query_posts($args);
