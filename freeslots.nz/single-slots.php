...
<?php
      ...
      <section class="gates container">
        <div class="gates__container">
          <div class="gates__rating">
            <h1 class="gates__title"><?php the_title(); ?></h1>
            <div>
    ...
    <section class="game-information">
      <div class="container">
        ...
        <div class="game-information-text"> <?php the_field('archive_slots_content', 'option'); ?></div>
         ...
         <div class="info__post">
          <div>
                ...
                if(get_the_content()){
                  ...
                  if($slots_types){
                    echo vsprintf(__('<h2>%s Slot</h2><p>%s is an online slot created by %s.  It needs you to build up a winning combination to enjoy multiple gameplay features and generous bonuses.</p> <p>%s offers a solid gambling experience for free and for real money. With an RTP of %s, it demonstrates a high winning potential. The slot is available on various %s devices. To give it a try, you need to register at a gambling site, load the game, and press the “Spin” button.</p>', 'websitelangid'), array($slot_title, $slot_title, $slots_providers[0]->name, $slot_title, $slots_return_to_player,  $slots_availables[0]->name));
                  }?>
               <?php }
...
<section class="faq">
  ...
  echo vsprintf(__('
  <div class="slot-faq" itemscope itemtype="https://schema.org/FAQPage">
    <h2 class="faq__title">%s Slot FAQ</h2>
    <div class="faq__text" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
  ...
  </div>', 'websitelangid'), array($slot_title, $slot_title, $slots_types[0]->name, $slot_title,   $slot_title, $slot_title, $slot_title));
