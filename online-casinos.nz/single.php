					...
					<?php
							if(get_the_content()){
								...
								if($casinos_types){
									...
									echo vsprintf(__('<h1>%s</h1><p>%s is a crypto %s gambling site that has been established in %s. The cooperation with the best software providers helped it develop a solid collection of games. Various genres and themes attract thousands of players from all over the world.</p><p>
									%s has a lot of bonuses to offer. To start the gameplay, players need to make a deposit using %s. For withdrawals, they can use %s only . Lucky winners can cash out up to %s.
									</p>', 'websitelangid'), array($current_casino_title, $current_casino_title, $casinos_types_content_list,  $casino_established_date, $current_casino_title, $casinos_deposits[0]->name, $casino_withdrawal_limit, $casino_withdrawal_limit));
	 ...
	 <section class="faq">
			...
			<div class="slot-faq" itemscope itemtype="https://schema.org/FAQPage">
				...
				<div class="faq__text" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<h3 class="faq__question accordion" ><span itemprop="name"><?php the_sub_field('question');?></span>
						<div class="faq__svg">
			...
			<div class="slot-faq" itemscope itemtype="https://schema.org/FAQPage">
				...
				<div class="faq__text" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<div class="faq__question" >
						<p itemprop="name">Does %s have free slots?</p>
						<div class="faq__svg">
				...
				<div class="faq__text" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					...
					<div class="faq__answer" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
						<div itemprop="text"><p>Yes, it does. Being a legit %s gambling site, it offers a safe gaming and betting environment. Consequently, players have a chance to make real money.</p></div>
					</div>
				</div>
				<div class="faq__text" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<div class="faq__question">
						<p itemprop="name">What types of games are covered by %s?</p>
						<div class="faq__svg">
							<svg class="faq__svg-plus" viewBox="0 0 23 32" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" stroke-width="0.9143" d="M12.901 25.292v-22.027c0-0.386-0.159-0.754-0.437-1.022s-0.65-0.415-1.036-0.415-0.758 0.147-1.036 0.415v0c-0.278 0.268-0.437 0.635-0.437 1.022v22.027l-5.617-5.418c-0.138-0.133-0.3-0.237-0.478-0.308s-0.367-0.107-0.559-0.107c-0.191 0-0.381 0.036-0.559 0.107s-0.34 0.175-0.478 0.308c-0.138 0.133-0.248 0.291-0.323 0.467v0c-0.075 0.176-0.115 0.365-0.115 0.556s0.039 0.38 0.115 0.556c0.075 0.176 0.186 0.334 0.323 0.467l8.125 7.836c0 0 0 0 0 0l0 0 0.317-0.329 2.192-4.134zM12.901 25.292l5.617-5.418c0.138-0.133 0.3-0.237 0.478-0.308s0.367-0.107 0.559-0.107c0.191 0 0.381 0.036 0.559 0.107s0.34 0.175 0.478 0.308c0.138 0.133 0.248 0.291 0.323 0.467s0.114 0.365 0.114 0.556-0.039 0.38-0.114 0.556c-0.075 0.176-0.186 0.334-0.323 0.467l-8.125 7.836c-0 0-0 0-0 0l-0 0 0.436-4.463z" fill="black"/>
							</svg>
					...
					<div class="faq__answer" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
						<div itemprop="text"><p>The casino covers a wide range of genres, from slots to live dealer games. After checking the local gallery, players can find something that suits them.</p></div>
					</div>
				</div>
			</div>', 'websitelangid'), array($current_casino_title, $current_casino_title, $current_casino_title, $casinos_types_content_list,  $current_casino_title));
