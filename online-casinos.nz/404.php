...
<div class="wrapper row2">
  <div id="container" class="clear">
    ...
    <h1><?php echo __('WHOOPS!', 'websitelangid');?></h1>
      ...
      <p> <?php echo __('Go back to the!', 'websitelangid');?> <a href="javascript:history.go(-1)"><?php echo __('previous page!', 'websitelangid');?></a> <?php echo __('WHOOPS!', 'websitelangid');?>or visit our <a href="/"><?php echo __('homepage!', 'websitelangid');?></a></p>
