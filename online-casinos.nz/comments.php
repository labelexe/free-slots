...
<div class="comments-wrapper" <?php if($comments){?>itemtype="https://schema.org/Organization" itemscope<?php }?>>
	<div class="comments-flex slider__wrapper">
		<?php if($comments){?>
			...
			<button  class="slider__control prev" data-slide="prev">
				<svg class="slider__control-prev">
				<use href="<?php bloginfo( 'template_url' ); ?>/assets/svg/sprite.svg#icon-plus"></use>
				</svg>
			</button>
			<button class="slider__control next" data-slide="next">
				<svg class="slider__control-next">
				<use href="<?php bloginfo( 'template_url' ); ?>/assets/svg/sprite.svg#icon-plus"></use>
				</svg>
			</button>
			<ul class="slider__items">
				...
				?>
				<li class="slider__cards slider__item<?php if($comment_language_value == ICL_LANGUAGE_CODE){echo 'current-language-review';}else{echo 'foreign-language-review';}?>" id="comment-<?php echo $comment->comment_ID;?>" lang="<?php echo $comment_language_value;?>">
					<article itemprop="review" itemtype="https://schema.org/Review" itemscope>
						<div class="hiddenbox slider__cards-title" itemprop="itemReviewed" itemscope itemtype="https://schema.org/Organization"><span itemprop="name"></span></div>
						<meta itemprop="datePublished" content="<?php echo $comment->comment_date;?>"/>
							<h4 class="slider__cards-title" itemprop="author" itemtype="https://schema.org/Person" itemscope><span itemprop="name"><?php echo $comment->comment_author;?></span></h4>
							<div class="comment-rating stars casino-review-summary-rating" itemprop="reviewRating" itemtype="https://schema.org/Rating" itemscope>
								<?php
								if($comment_rating == 1){
									echo '<div class="hiddenbox stars"></div><i class="fas fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i>';
								}elseif($comment_rating == 2){
									echo '<div class="hiddenbox stars"></div><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i>';
								}elseif($comment_rating == 3){
									echo '<div class="hiddenbox stars"></div><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i>';
								}elseif($comment_rating == 4){
									echo '<div class="hiddenbox stars"></div><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i>';
								}elseif($comment_rating == 5){
									echo '<div class="hiddenbox stars"></div><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>';
								}else{
									echo '<div class="hiddenbox stars"></div><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>';
								}
								?>
							</div>
								<p class="slider__cards-text" itemprop="reviewBody"><?php echo $comment->comment_content;?></p>
					</article>
					<time class="slider__cards-date" datetime="<?php echo $comment->comment_date;?>"><?php echo $comment->comment_date;?></time>
				</li>
				<?php }?>
			</ul>
<script>
